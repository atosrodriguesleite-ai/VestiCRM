...
| RN-022 | Mapa de envios com dois recortes: "todos os pedidos pagos" (endereço do envio ou, na falta, da cliente) e "Melhor Envio" (só etiquetas, sem canceladas); o que não tem estado é contado e dito na tela | `lib/envios/mapa.ts` | `mapa-envios.test.ts` |
