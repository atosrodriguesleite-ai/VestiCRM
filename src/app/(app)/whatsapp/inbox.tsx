...
export function Inbox({
  ...
  return (
    <div className="max-w-7xl flex overflow-hidden bg-white -mx-4 -mt-4 -mb-24 h-[calc(100dvh-120px-var(--kb,0px))] rounded-none border-0 shadow-none md:mx-auto md:mt-0 md:mb-0 md:h-[calc(100dvh-120px)] md:rounded-2xl md:border md:border-gray-100 md:shadow-card">
      {/* Lista de conversas */}
      <div
